 ...
 */
public class FavouriteArrayAdapter extends ArrayAdapter<Post> {

    private final Context context;
    private List<Post> values = new ArrayList<Post>();
    private int height;

    public FavouriteArrayAdapter(Context context, int resource, ArrayList<Post> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView titluPost = (TextView) rowView.findViewById(R.id.titluPost2);
        TextView miniContinutPost = (TextView) rowView.findViewById(R.id.miniContinutPost2);
        ...
        ImageView imageView = (ImageView)rowView.findViewById(R.id.buttonColorBar2);
